...
export function HomeNav() {
  ...
  return (
    <nav
      ...
      className="sticky top-0 z-30 w-full border-b border-slate-800/80 bg-slate-950/90 px-4 py-3 pt-[max(0.75rem,env(safe-area-inset-top,0px))] backdrop-blur-md supports-[backdrop-filter]:bg-slate-950/75"
    >
